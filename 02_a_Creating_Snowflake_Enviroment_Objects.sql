...
CREATE SCHEMA IF NOT EXISTS ANALYTICS.SNAPSHOT;
...
GRANT USAGE ON SCHEMA ANALYTICS.SNAPSHOT TO ROLE TRANSFORMER;
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA ANALYTICS.SNAPSHOT TO ROLE TRANSFORMER;
GRANT SELECT, INSERT, UPDATE, DELETE ON FUTURE TABLES IN SCHEMA ANALYTICS.SNAPSHOT TO ROLE TRANSFORMER;
GRANT CREATE TABLE ON SCHEMA ANALYTICS.SNAPSHOT TO TRANSFORMER;
